<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(<?php echo BASEURL; ?>/images/bg/9.png) no-repeat scroll center center / cover ;">
        ...
        <div class="htc__testimonial__area ptb--120" style="background: rgba(0, 0, 0, 0) url(<?php echo BASEURL; ?>/images/bg/4.jpg) no-repeat scroll center center / cover ;" data--black__overlay="6">
            <div class="container">
                <div class="row">
                        ...
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo BASEURL; ?>/images/test/client/1.png" alt="testimonial images">
                                </div>
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo BASEURL; ?>/images/test/client/2.png" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo BASEURL; ?>/images/test/client/3.png" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="brand__list">
                            <li><a href="#">
                                <img src="<?php echo BASEURL; ?>/images/brand/1.png" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?php echo BASEURL; ?>/images/brand/2.png" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?php echo BASEURL; ?>/images/brand/3.png" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?php echo BASEURL; ?>/images/brand/4.png" alt="brand images">
                            </a></li>
                            <li class="hidden-sm"><a href="#">
                                <img src="<?php echo BASEURL; ?>/images/brand/5.png" alt="brand images">
                            </a></li>
                        </ul>
                    </div>
                </div>
